  ...
  return (
    <>
      <PageTemplate title="Safa-Outdoor">
        <div
          className="absolute flex flex-col gap-10 items-center bg-cover bg-center bg-no-repeat min-h-screen "
          style={{
        ...
        <section className="grid place-items-center" data-aos="zoom-in-up">
          <div className="text-center sm:w-10/12 md:w-8/12 lg:w-8/12">
            <PageSentence
              badge="SERVICES"
              title="Selain Sewa Alat, Ada layanan apa aja di Safa Outdoor ?"
            />
          </div>
        </section>
        <section className="grid grid-cols-1 gap-6 sm:gap-8 place-items-center lg:grid-cols-2">
          ...
          >
            <SectionSentence
              title="Kewalahan handle acara besar?"
              paragraph="Sekarang udah nggak perlu pusing lagi ngurusin acara besar, semua kebutuhan acara besar kaya PERSAMI, JAMBORE, GATHERING, OUTING, OUTBOUND bisa kita urus disini"
              badge="BIG EVENT"
            />
            <div className="grid gap-6 w-full place-items-end md:w-8/12 lg:w-full">
              <aside className="w-full grid grid-cols-1 gap-5">
                <Text value={"List Service"} textStyle={"SectionBadge"} />

                <CardListIcon
                  icon={<FaBusAlt />}
                  title="Antar jemput peserta dan peralatan"
                />
                <CardListIcon icon={<FaTicketAlt />} title="Tikcketing" />
                <CardListIcon
                  icon={<FaCampground />}
                  title="Setup tenda, dengan crew yang berpengalaman"
                />
                <CardListIcon
                  icon={<GiKnifeFork />}
                  title="Catering, Snack, Sarapan, Makan Siang/Malam"
                />
                <CardListIcon
                  icon={<MdElectricBolt />}
                  title="Kelistrikan, mulai dari Audio, Speaker, Kabel, dan Lightning"
                />
                <CardListIcon
                  icon={<FaCamera />}
